...
class SqlCRUD(AbstractLOL):
    ...
    def ModificarInvocador(self, Comportamiento):
        ...
        return (Comportamiento.Name + " se le cambio el comportamiento por: " + Comportamiento.Comportamiento)
...
#    invocador3 = player.DatosSummoner('l irving l')
    NewInvocador = crud.CrearInvocador(invocador1)
    print(NewInvocador)
...
#    comp= Comportamiento('l Irving l', 'baneado')
